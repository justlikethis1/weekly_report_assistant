...
class MemoryManager:
    ...
    def __init__(self):
        self.max_memory_size = config_manager.config.memory.max_size
        self.max_user_input_length = config_manager.config.memory.max_user_input_length
        self.max_ai_response_length = config_manager.config.memory.max_ai_response_length
